...
export const AMIT_ENTERPRISE_EMAIL_BANK: EmailTemplate[] = [
  ...
  {
    id: "amit-talent-email-10",
    name: "Talent 02: Leadership Pipeline & Succession",
    category: "outreach",
    subject: "Leadership pipeline & succession",
    description: "Email 10 (Day 5): Moving from succession charts to actionable developmental readiness.",
    owner: "amit",
    createdBy: "Amit Shelly",
    isSystem: false,
    htmlContent: generateAmitEmailHtml({
      ...
      leadParagraph: "A strong succession plan isn't only about identifying who could move into the next role.",
      paragraphs: [
        "It is also about understanding:",
        "<strong>What does that person need to develop before they are ready?</strong>",
        "That development could involve coaching, leadership capability building, behavioural development or exposure to specific business challenges.",
        "This is where structured development journeys can complement succession planning and de-risk leadership continuity.",
      ],
      highlightSentence: "Bridging the gap between succession nomination and true leadership readiness.",
      closingNote: "Would be happy to understand how {{companyName}} currently approaches leadership readiness.",
      whatsappMessage: "Hi Amit, Succession readiness is an important topic for {{companyName}}. Let's connect for 20 mins.",
    }),
  },
  {
